...
class MultipleSelect extends React.Component<SelectProps<SelectValue>> {
  ...
  render() {
    ...
    return (
      <Select showSearch allowClear mode="multiple" filterOption={this.onFilterChildren} {...restProps}>
        {children}
      </Select>
    );
  }
